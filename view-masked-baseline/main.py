from utils import *
from trainers import ViewMaskedBaselineTrainer
import time
...
def main():
    ...
    if args.resume:
        ...
        trainer = ViewMaskedBaselineTrainer(args, num_classes, logger)
        start_epoch = 0
    ...
    for epoch in range(start_epoch, total_epoch):
        ...
        meters_trn = trainer.train_epoch(train_loader, args.view_labeled, epoch)
