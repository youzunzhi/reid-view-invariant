...
class Resnet50WithViewClassifier(nn.Module):
    def __init__(self, num_classes, num_views):
        super(Resnet50WithViewClassifier, self).__init__()
        self.layers = [3, 4, 6, 3]
        self.inplanes = 64
        ...
        self.vc_fc2 = nn.Linear(512, num_views)
    ...
    def forward(self, x, alpha=0):
        ...
        view = self.vc_fc2(view_x)

        return feature, label, view
