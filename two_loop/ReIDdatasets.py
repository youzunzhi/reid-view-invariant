...
class MSMT_train_view(MSMT):
    def __init__(self, root, transform=None, require_views=True):
        super(MSMT_train_view, self).__init__(root, transform, require_views)
...
class MSMT_train_label(MSMT):
    def __init__(self, root, view_labeled, transform=None, require_views=True):
        super(MSMT_train_label, self).__init__(root, transform, require_views)
