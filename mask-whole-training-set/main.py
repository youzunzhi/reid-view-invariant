...
def main():
    ...
    train_masked_loader, gallery_loader, probe_loader = get_reid_dataloaders(args.dataset, args.img_size, args.crop_size,
                                                                      args.padding, args.batch_size, args.view_labeled)
    num_classes = train_masked_loader.dataset.return_num_class()
    ...
    for epoch in range(start_epoch, total_epoch):
        ...
        meters_trn = trainer.train_epoch(train_masked_loader, args.view_labeled, epoch, total_epoch)
